...
1. In de **Sjablonen** venster, selecteert u de **+** pictogram naast **Sjablonen** en kiest u **PDF-sjabloon**.
1. In de **Nieuwe PDF-sjabloon** selecteert u een fabriekssjabloon die u als basis wilt gebruiken om de aangepaste sjabloon te maken. U kunt ook het zoekvak gebruiken om te zoeken naar een sjabloon.
