---
title: Native PDF | PDF-productie
...
| **Taal** | Selecteer de taal die u voor de uitvoer wilt gebruiken. <br> **Nota**: De teksten van de verwijzing zoals &quot;zie op hoofdstuk&quot;of &quot;zie op pagina&quot;worden gecontroleerd door een taalvariabele. De variabele gebruikt de taal die in het onderwerp door het `xml:lang` attribuut wordt bepaald. Als daar geen taal wordt gespecificeerd, neemt het de vooraf ingestelde taal. Als beide ontbreken, is het gebrek aan Engels (en_US). |
