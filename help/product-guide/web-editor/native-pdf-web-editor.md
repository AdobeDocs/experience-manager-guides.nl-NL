...
Voor meer informatie bij het produceren van een PDF die de methode DITA-OT gebruikt, zie [PDF genereren met DITA-OT](/help/product-guide/user-guide/generate-output-pdf.md).
...
Zie voor meer informatie over het configureren van FMPS [Uitvoer genereren op basis van FrameMaker-documenten](/help/product-guide/user-guide/fm-output-generate.md).
