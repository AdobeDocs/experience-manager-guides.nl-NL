...
Met de Algemene instellingen kunt u de instellingen configureren voor gebruik van de Editor. Dit lusje bevat zeven secties: **AI Medewerker**, **Authoring**, **Bevragingen**, **Voorwaarde**, **de redacteur van HTML**, **Lerende inhoud**, en **controle van de Spel**.
...
- **het Leren inhoud**: Dit het plaatsen staat u toe om de Opleiding van het Product en het Leren inhoudseigenschap voor uw instantie van Experience Manager Guides toe te laten of onbruikbaar te maken. Gebruik **toelaten het Leren inhoud** knevel om de eigenschap op een omslag-profielniveau toe te laten of onbruikbaar te maken. Deze functie blijft standaard uitgeschakeld voor alle instanties.
  ...
  De volgende functies/opties worden alleen beschikbaar wanneer de instelling voor leerinhoud is ingeschakeld:
   ...
   - **auteursrecht van de Cursus**: Laat opties toe om Cursussen van zowel de Redacteur als de Homepage tot stand te brengen en te beheren.
   - **SCORM malplaatjes**: Laat de optie toe om SCORM malplaatjes onder *malplaatjes van de Output* in de Redacteur tot stand te brengen.
   - **de malplaatjes van de Inhoud en de vooraf instelt van de Output**: Laat de malplaatjes van de Inhoud en de vooraf instelt van de Output configuratieopties in de de montagedialoog van Workspace toe.
