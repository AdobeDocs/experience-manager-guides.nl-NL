---
title: Opmerkingen bij de release | Upgradeinstructies en opgeloste problemen in Adobe Experience Manager Guides, release 2026.01.0
description: Leer meer over de compatibiliteitsmatrix en hoe u een upgrade uitvoert naar de release van 2026.01.0 van Adobe Experience Manager Guides as a Cloud Service.
...
# Upgrade-instructies voor de release van 2026.01.0

Dit artikel behandelt de upgrade-instructies en de compatibiliteitsmatrix voor de release 2026.01.0 van Adobe Experience Manager Guides as a Cloud Service.
...
In deze sectie wordt de compatibiliteitsmatrix voor de softwaretoepassingen vermeld die worden ondersteund door de release 2026.01.0 van Experience Manager Guides as a Cloud Service.

### FrameMaker en FrameMaker Publishing Server

| Experience Manager Guides als Cloud Release | FMPS | FrameMaker | Zuurstofauteur |
| --- | --- | --- | --- |
| 2026,01,0 | Niet compatibel | 2022 of hoger | 26,1 |
...
Zoals per standaardgedrag DITA, moet het scope= `external` attribuut niet op interne verbindingen worden toegepast, aangezien het slechts voor verwijzingen naar externe middelen bedoeld is. Het toepassen van deze eigenschap op interne verbindingen en het verplaatsen van dergelijke activa kunnen werkschema&#39;s verstoren. Voor inhoud die in Experience Manager Guides wordt beheerd, gebruik in plaats daarvan de standaardscope= `local` of op sleutel-gebaseerde verwijzingen.

## Upgrade naar 2026.01.0-release
