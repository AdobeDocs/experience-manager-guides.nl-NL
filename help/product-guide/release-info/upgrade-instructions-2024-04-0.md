...
description: Leer meer over de compatibiliteitsmatrix en hoe u een upgrade uitvoert naar de release 2024.04.0 van Adobe Experience Manager Guides as a Cloud Service.
...
Deze sectie bevat een overzicht van de compatibiliteitsmatrix voor de softwaretoepassingen die worden ondersteund door de release 2024.04.0 van Experience Manager Guides as a Cloud Service.
...
1. Zodra de taak is voltooid, reageert het vorige GET-verzoek met succes. Als de taak om wat voor reden dan ook mislukt, kan de fout worden gezien in serverlogboeken.
