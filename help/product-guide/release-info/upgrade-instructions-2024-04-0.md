...
# Upgrade-instructies voor de release van 2024.04.0

Dit artikel behandelt de upgrade-instructies en de compatibiliteitsmatrix voor de 2024.04.0-release van Adobe Experience Manager Guides as a Cloud Service.
...
Voor de lijst met problemen die in deze release zijn opgelost, raadpleegt u [Opgeloste problemen in de release 2024.04.0](fixed-issues-2024-04-0.md).

## Compatibiliteitsmatrix

In deze sectie wordt een overzicht gegeven van de compatibiliteitsmatrix voor de softwaretoepassingen die worden ondersteund door de 2024.04.0-release van Experience Manager Guides as a Cloud Service.

### FrameMaker en FrameMaker Publishing Server

| Hulplijnen Experience Managers als cloudrelease | FMPS | FrameMaker |
| --- | --- | --- |
| 2024,04,0 | Niet compatibel | 2022 of hoger |
| | | |
...
1. Zodra de baan wordt voltooid, antwoordt het vorige verzoek van de GET met succes. Als de taak om wat voor reden dan ook mislukt, kan de fout worden gezien in serverlogboeken.
