...
2. Werk de eigenschap `<dox.version>` in het `/dox/dox.installer/pom.xml` -bestand van de Git-code voor Cloud Services bij naar 2023.12.0.16.
3. Leg de wijzigingen vast en voer de Cloud Services-pijplijn uit om naar de release van december 2023 van Experience Manager Guides as a Cloud Service te upgraden.
...
- De **Titel** in het lusje van de Redacteur van het Web wordt beknot na een punt (.) karakter. 14372
...
- De getagde weergave van de PDF-reactor in de publicatie-uitvoer van Native PDF werkt niet zoals u had verwacht. (13622)
- Bij het publiceren van AEM Site wordt een probleem aangetroffen wanneer u zich vastlegt aan de datastore voor grote kaarten met peer-bereikkoppelingen. 13531
...
- AEM-cloudomgevingen hebben te maken met een MongoWrite-uitzondering vanwege grote knooppunten. 13509
...
Adobe heeft het volgende bekende probleem voor de release van december 2023 geïdentificeerd:
