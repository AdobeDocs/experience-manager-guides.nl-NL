---
title: Opmerkingen bij de release | Upgrade-instructies voor de Adobe Experience Manager Guides 5.1.0 Service Pack 4-release
description: Leer over de verenigbaarheidsmatrijs en hoe te om aan de 5.1.0 versie van Service Pack 4 van Adobe Experience Manager Guides te bevorderen.
...
# Upgrade-instructies voor de 5.1.0 Service Pack 4-release (april 2026)

Dit artikel behandelt de verbeteringsinstructies en de verenigbaarheidsmatrijs voor 5.1.0 Service Pack 4 versie van Adobe Experience Manager Guides.

Voor de lijst van kwesties die in deze versie zijn bevestigd, mening [&#x200B; Vaste kwesties in 5.1.0 Service Pack 4 versie &#x200B;](../release-info/fixed-issues-5-1-0-sp4.md).

## Compatibiliteitsmatrix

In deze sectie wordt een overzicht gegeven van de compatibiliteitsmatrix voor de softwaretoepassingen die worden ondersteund door Experience Manager Guides 5.1.0 Service Pack 4.
...
| Geen | FMPS | FM |
| --- | --- | --- |
| 5.1.0 Service Pack 4 (UUID) | Ondersteund | 2022 of hoger |
...
## Upgrade naar 5.1.0 Service Pack 4-release van Experience Manager Guides

U kunt uw huidige versie van Experience Manager Guides aan versie 5.1.0 Service Pack 4 op **AEM 6.5** of **AEM 6.5 LTS** gemakkelijk bevorderen.

>[!NOTE]
>
> Als u momenteel op AEM 6.5 en van plan bent om naar AEM 6.5 LTS te bewegen, mening [&#x200B; Bevorderend aan Adobe Experience Manager (AEM) 6.5 LTS &#x200B;](https://experienceleague.adobe.com/nl/docs/experience-manager-65-lts/content/implementing/deploying/upgrading/upgrade).

Voordat u verdergaat met de upgrade naar versie 5.1.0 Service Pack 4 van Experience Manager Guides, moet u rekening houden met de volgende punten:

- Als u versie 5.1.0 of 5.1.x gebruikt, dan kunt u aan versie 5.1.0 Service Pack 4 direct bevorderen.
