---
title: Opmerkingen bij de release | Upgradeinstructies en opgeloste problemen in Adobe Experience Manager Guides, release 2024.10.0
description: Leer meer over de compatibiliteitsmatrix en hoe u een upgrade uitvoert naar de release 2024.10.0 van Adobe Experience Manager Guides as a Cloud Service.
...
# Upgrade-instructies voor de release van 2024.10.0

Dit artikel behandelt de upgrade-instructies en de compatibiliteitsmatrix voor de release 2024.10.0 van Adobe Experience Manager Guides as a Cloud Service.
...
In deze sectie wordt een overzicht gegeven van de compatibiliteitsmatrix voor de softwaretoepassingen die worden ondersteund door de release 2024.10.0 van Experience Manager Guides as a Cloud Service.

### FrameMaker en FrameMaker Publishing Server

| Experience Manager Guides als Cloud Release | FMPS | FrameMaker |
| --- | --- | --- |
| 2024 10,0 | Niet compatibel | 2022 of hoger |
| | | |
...
## Upgrade naar 2024.10.0 release
