---
title: Opmerkingen bij de release | Upgrade-instructies en opgeloste problemen in Adobe Experience Manager Guides, release 2026.04.0
description: Leer meer over de compatibiliteitmatrix en hoe u een upgrade uitvoert naar de release van 2026.04.0 van Adobe Experience Manager Guides as a Cloud Service.
...
# Upgrade-instructies voor de release van 2026.04.0

Dit artikel behandelt de upgrade-instructies en de compatibiliteitsmatrix voor de release 2026.04.0 van Adobe Experience Manager Guides as a Cloud Service.
...
In deze sectie wordt de compatibiliteitsmatrix voor de softwaretoepassingen vermeld die worden ondersteund door de release 2026.04.0 van Experience Manager Guides as a Cloud Service.

### FrameMaker en FrameMaker Publishing Server

| Experience Manager Guides als Cloud Release | FMPS | FrameMaker | Zuurstofauteur |
| --- | --- | --- | --- |
| 2026,04,0 | Niet compatibel | 2022 of hoger | 26,1 |
...
## Upgrade naar 2026.04.0-release
