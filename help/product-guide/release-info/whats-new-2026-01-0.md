...
Het uitgeven van de eigenschappen van het Dossier is nu beperkt voor dossiers die op **Gelezen slechts** wijze zijn. Als een dossier door een andere gebruiker (beschikbaar op Gelezen slechts wijze) wordt gesloten, kunt u geen meta-gegevensbezit veranderen, of van het [ Juiste paneel ](../user-guide/web-editor-right-panel.md#file-properties), de **3} optie van Eigenschappen {in het** contextmenu van een dossier [, of het ](../user-guide/web-editor-other-features.md#context-menu-functions-on-a-files-tab) Rapport van Meta-gegevens [. ](../user-guide/reports-web-editor.md#metadata-report) Zo voorkomt u onbedoelde wijzigingen in alleen-lezen bestanden.
