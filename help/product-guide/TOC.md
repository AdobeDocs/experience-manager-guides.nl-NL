   ...
   - Opmerkingen bij de release {#release-notes}
      - Cloud Services {#cloud-release-notes}
         ...
         - Versies van 2026 {#2026-releases}
            - 2026.04.0 Release {#2604-release}
               - [Nieuwe functies](./release-info/whats-new-2026-04-0.md)
               - [Opgeloste problemen](./release-info/fixed-issues-2026-04-0.md)
               - [Upgradeinstructies](./release-info/upgrade-instructions-2026-04-0.md)
         ...
         - Versies van 2025 {#2025-releases}
            - 2025.11.0 Release {#2511-release}
               ...
               - [Opgeloste problemen](./release-info/fixed-issues-2025-11-0.md)
               - [Upgradeinstructies](./release-info/upgrade-instructions-2025-11-0.md)
      ...
      - On-prem/Managed Services {#on-prem-release-notes}
         ...
         - 5.1.0 SP4-release {#510-sp4-release}
            - [Opgeloste problemen](./release-info/fixed-issues-5-1-0-sp4.md)
            - [Upgradeinstructies](./release-info/upgrade-instructions-5-1-0-sp4.md)
         - 5.1.0 SP3 Release {#510-sp3-release}
            - [Nieuwe functies](./release-info/whats-new-5-1-3.md)
            - [Opgeloste problemen](./release-info/fixed-issues-5-1-0-sp3.md)
            - [Upgradeinstructies](./release-info/upgrade-instructions-5-1-0-sp3.md)
         - 5.1.0 SP1-release {#510-sp1-release}
            - [Opgeloste problemen](./release-info/fixed-issues-5-1-0-sp1.md)
            - [Upgradeinstructies](./release-info/upgrade-instructions-5-1-0-sp1.md)
         ...
         - 5.0.0 SP4-release {#500-sp4-release}
            - [Opgeloste problemen](./release-info/fixed-issues-5-0-0-sp4.md)
         ...
         - 4.3.0 Release {#43-release}
            ...
            - Aanvullende informatie {#43-release-notes}
         ...
         - 4.2 Release {#42-release}
            ...
            - Aanvullende informatie {#42-release-notes}
         ...
         - [Opmerkingen bij de release 4.0.x](https://helpx.adobe.com/nl/xml-documentation-for-experience-manager/release-note/release-notes-xml-documentation-solution-4-0.html)
         - [Opmerkingen bij de release 3.8.x](https://helpx.adobe.com/nl/xml-documentation-for-experience-manager/release-note/release-notes-xml-documentation-solution-3-8.html)
- Handboek (nieuwe gebruikersinterface) {#user-guide}
   ...
   - Inhoud auteur {#author-content}
      ...
      - Editor {#work-with-editor}
         ...
         - De interface en functies van de Editor kennen {#editor-interface-features}
            - [Overzicht](./user-guide/intro-editor-interface.md)
   ...
   - Kaartbeheer en publicatie {#map-management-publishing}
      ...
      - Uitvoergeneratie {#output-gen}
         ...
         - [Veelgestelde vragen over publicatieworkflow en schaalbaarheid](./user-guide/publishing-scalability-faq.md)
      - Bulkactivering van inhoud {#bulk-activation}
         ...
         - [Replicatie van DITA-bronelementen beheren](./user-guide/dita-assets-replication-aem-sites.md)
   ...
   - Leerinhoud beheren {#learning-training-content}
      - Aan de slag - handleiding {#get-started}
         ...
         - Leerinhoud maken en aanpassen {#customize-lc}
            ...
            - [Andere opties in het menu Invoegen](./learning-content/lc-other-insert-options.md)
   ...
   - Bijlage {#appendix}
      - Inhoud beheren {#manage-content}
         ...
         - [Proceselementen](./user-guide/asset-processor.md)
      - Problemen oplossen {#troubleshooting}
         - [Time-out sessie](./user-guide/session-timeout-prompt.md)
- Handboek (oude gebruikersinterface) {#user-guide-old-ui}
   - [AEM Guides-overzicht](https://experienceleague.adobe.com/nl/docs/experience-manager-guides/using-old-ui/overview){target="_blank"}
- Installatie en configuratie {#install-guide}
   - Op locatie {#on-prem-ig}
      ...
      - Werken met instellingen voor het genereren van uitvoer {#output-gen-config}
         ...
         - [AEM Sites-sjablonen downloaden en installeren](./install-guide/download-install-aem-sites-templates.md)
         - [Componenttoewijzing voor AEM Sites](./install-guide/component-mapping.md)
   ...
   - Cloud Services {#cs-ig}
      ...
      - AEM Guides implementeren en configureren als Cloud Service {#deploy-conf-aemg-cs}
         ...
         - [Aanvullende configuratie voor het upgraden van AEM Guides als Cloud Service](./cs-install-guide/additional-config-for-cloud-service.md)
      ...
      - Werken met instellingen voor het genereren van uitvoer {#output-gen-config-cs}
         ...
         - [Componenttoewijzing voor AEM Sites](./cs-install-guide/component-mapping.md)
...
- Installatie en configuratie {#install-conf-guide}
   ...
   - Installatieproces voor Cloud Service {#deploy-conf-aemg-cs}
      - [Configuratie van implementatie en verzender](./install-conf-guide/conf-deployment-dispatcher-cs.md)
   - Installatieproces voor on-premise {#deploy-conf-aemg-on-prem}
      - [Technische voorschriften](./install-conf-guide/aemg-technical-requirements.md)
      - [Adobe Experience Manager installeren](./install-conf-guide/download-install-aem.md)
      - [Voor het eerst AEM Guides downloaden en installeren](./install-conf-guide/download-install-aemg-first-time.md)
      - [Dispatcher configureren](./install-conf-guide/conf-dispatcher.md)
      - [AEM Guides verwijderen](./install-conf-guide/uninstall-aemg.md)
   - [AEM Guides-installatie verifiëren](./install-conf-guide/verify-aemg-installation.md)
   - Upgrade uitvoeren voor AEM Guides {#upgrade-aemg}
      - Cloud Service {#cloud-service}
         - [Upgrade van AEM Guides Cloud Service uitvoeren](./install-conf-guide/download-install-upgrade-aemg.md)
   ...
   - Gebruikersgroepen en beveiliging {#user-group-sec-cs}
      - [Gebruikersbeheer](./install-conf-guide/user-admin-sec.md)
   - Systeeminstellingen {#aemg-system-settings}
   ...
   - Editor-configuraties {#editor-configs}
      ...
      - [Een aangepast deelvenster configureren in het linkerdeelvenster](./install-conf-guide/conf-custom-panel.md)
      - [Standaardwaarde voor de weergave Codes configureren](./install-conf-guide/conf-default-value-tags-view.md)
      - [Element-id&#39;s automatisch genereren](./install-conf-guide/auto-generate-element-ids.md)
      ...
      - Editor-instelling voor Op locatie {#editor-on-prem-settings}
         - [Aanvullende speciale tekens voor Op locatie configureren](/help/product-guide/web-editor/conf-additional-special-characters.md)
         - [De titel configureren voor de pictogrammen Inchecken en Uitchecken voor Op locatie](./install-conf-guide/conf-checkin-checkout-title.md)
         - [Vorm het aantal LimitReads voor een vraag voor Op-Premise](./install-conf-guide/conf-query-limitreads.md)
      - Gegevensbronaansluiting {#data-source}
