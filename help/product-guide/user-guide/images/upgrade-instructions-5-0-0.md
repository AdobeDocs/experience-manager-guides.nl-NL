---
title: Opmerkingen bij de release | Upgrade-instructies voor de release van Adobe Experience Manager Guides 5.0.0
...
Voor meer informatie over de nieuwe eigenschappen en de verhogingen, mening [&#x200B; wat in de 5.0.0 versie &#x200B;](/help/product-guide/release-info/whats-new-5-0-0.md) nieuw is.

Voor de lijst van kwesties die in deze versie zijn bevestigd, mening [&#x200B; Vaste kwesties in de 5.0.0 versie &#x200B;](/help/product-guide/release-info/fixed-issues-5-0-0.md).
...
Voor meer details, bekijk de [&#x200B; Technische vereisten &#x200B;](/help/product-guide/install-guide/download-install-technical-requirements.md) sectie in de Gids van de Installatie en van de Configuratie op locatie.
...
Voor details, mening [&#x200B; de instructies van de Verbetering voor de On-premise versies &#x200B;](/help/product-guide/install-guide/upgrade-xml-documentation.md) van Experience Manager Guides.
