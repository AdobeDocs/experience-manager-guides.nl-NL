...
1. Selecteer de **Site AEM** uitvoervoorinstelling.
...
>[!NOTE]
>
>Als u afzonderlijke pagina&#39;s hebt gegenereerd voor de `conref` met AEM versie 3.5 of lager van de hulplijnen, wordt aangeraden deze pagina&#39;s te verwijderen of opnieuw te verwijderen met de opdracht [Orphan-sitepagina&#39;s verwijderen](#delete-orphan-page-aem-site) -optie.
...
Zie voor meer informatie *Samenvoegen van AEM siteknooppuntstructuur configureren* in de handleiding Adobe Experience Manager-hulplijnen installeren en configureren.
