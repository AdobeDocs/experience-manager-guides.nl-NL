...
>[!NOTE]
>
> Met de Experience Manager Guides 2026.03.0-release beschikt u over een nieuwe basislijn (Beta) met verbeterde prestaties en stabiliteit. Om deze basislijn te gebruiken, contacteer het Team van het Succes van de Klant om de eigenschap te hebben toegelaten. Leer meer over de [&#x200B; Nieuwe Basislijn (Beta) &#x200B;](./web-editor-baseline-v2.md).
