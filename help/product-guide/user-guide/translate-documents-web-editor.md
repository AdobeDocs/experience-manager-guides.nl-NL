...
1. Selecteer **toepassen**. Een lijst met details van onderwerpen en bijbehorende activa wordt getoond.
   ...
   >[!NOTE]
   >
   > Wanneer u kaarten vertaalt met verwijzingen naar DITAVAL- en markeringsbestanden en wanneer de vertaling is gebaseerd op de werkkopie, worden verwijzingen zoals afbeeldingen en andere gekoppelde elementen opgenomen, mits deze in de brontaalmap staan. Deze verwijzingen worden weergegeven in de referentielijst van het Vertaaldashboard, zodat u ze expliciet kunt selecteren voor vertaling. Tijdens het vertalen worden de middelen waarnaar wordt verwezen, naar de doeltaalmap gekopieerd en op dezelfde manier verwerkt als bij het standaardgedrag voor het vertalen van afbeeldingen.
