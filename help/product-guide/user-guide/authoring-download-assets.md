...
1. In het dialoogvenster Kaart downloaden kunt u de volgende opties kiezen:
   ...
   - **de hiërarchieopties van het Dossier**: U kunt het drop-down van de dossierhiërarchie ook gebruiken om te kiezen hoe de omslagstructuur voor uw gedownloade kaartdossiers wordt behandeld. De beschikbare opties zijn:
      ...
      - **afvlakte dossierhiërarchie**: Selecteer deze optie van dropdown om alle referenced onderwerpen en media dossiers in één enkele omslag te downloaden.

     Voor elke optie kunt u verder opgeven hoe bestandsnamen worden verwerkt voor gedownloade bestanden. De volgende opties voor bestandsnaam zijn beschikbaar:

      - **het dossiernaam van het Gebruik GUID**: Downloadt het kaartdossier met GUID als dossiernaam.
      - **Gebruik daadwerkelijke dossier - naam**: Downloadt het kaartdossier met zijn originele dossier - naam. Als deze optie wordt gebruikt in de hiërarchie van samengevoegde bestanden, worden eventuele dubbele bestandsnamen op de kaart automatisch opgelost door numerieke achtervoegsels (_2, _3, enzovoort) toe te voegen om unieke bestandsnamen te garanderen.
...
Wanneer de kaart is gedownload, kunt u de kaart selecteren en het pictogram Openen bovenaan gebruiken om de gedownloade inhoud te openen. Als u de bijbehorende metagegevens van de gedownloade kaart wilt weergeven, opent u het `metdata.json` -bestand dat is opgenomen in de gedownloade inhoud. Dit dossier is beschikbaar voor zowel *de hiërarchie van het Dossier* opties - afvlakken dossierhiërarchie en behouden dossierhiërarchie.
...
Wanneer de kaart is gedownload, kunt u de kaart selecteren en het pictogram Openen bovenaan gebruiken om de gedownloade inhoud te openen.
