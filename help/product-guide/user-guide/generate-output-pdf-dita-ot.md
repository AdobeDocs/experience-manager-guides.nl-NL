...
| Uitvoerpad/bestemmingspad | Het pad in uw AEM-opslagplaats waar de PDF is opgeslagen.<br><br> u kunt variabelen ook gebruiken terwijl het plaatsen van de Weg van de Bestemming. Voor meer details over het gebruiken van variabelen, mening [ variabelen van het Gebruik voor het plaatsen van de Weg van de Bestemming, de Naam van de Plaats, of de opties van de Naam van het Dossier ](generate-output-use-variables.md#id18BUG70K05Z). |
