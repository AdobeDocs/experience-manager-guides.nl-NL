---
title: Opslagplaats op startpagina
...
# De interface voor gegevensopslagruimte kennen

De gegevensopslagruimte fungeert als een gecentraliseerde ruimte voor een betere ontdekkingsmogelijkheden voor mappen en bestanden. Het biedt een uitgebreide tabelweergave van mappen en bestanden met meerdere kolommen en biedt contextafhankelijke details voor alle bestanden en elementen.

Deze interface stroomlijnt meerdere functies, zoals het maken van nieuwe bestanden of mappen, het bewerken van bestanden, het uploaden van elementen en het zoeken naar bestanden met robuuste filteropties, waardoor u verzekerd bent van efficiëntie en gebruiksgemak.

![](images/repository-view-home.png){align="left"}

De Repository-interface is onderverdeeld in de volgende secties:

- Navigatiebalk opslagplaats
- Tabellarische weergave van opslagplaats

## Navigatiebalk opslagplaats

De navigatiebalk voor de opslagplaats, die zich boven aan de interface voor opslagplaats bevindt, biedt snel toegang tot de belangrijkste handelingen zoals deze worden vermeld.

![](images/tab-bar-repository-view.png){align="left"}


- **het navigatievenster van de Omslag**: Toont een hiërarchische, boommening van omslagen binnen de Bewaarplaats, toelatend naadloze navigatie. In dit deelvenster wordt alleen informatie op mapniveau weergegeven. Wanneer u een map hier selecteert, worden de inhoud, bestanden en submappen van de map weergegeven in de weergave Opslag. U kunt dit deelvenster tonen of verbergen met het pictogram dat hieronder is gemarkeerd.

  ![](images/folder-navigation-panel.png){align="left"}

- **Broodkruimels**: Wijst op de huidige weg binnen de Bewaarplaats, die de hiërarchie van omslagen toont die aan uw huidige omslag leiden. U kunt deze selecteren om terug te keren naar een specifieke map in de hiërarchie.
...
De gegevensopslagruimte fungeert als de centrale ruimte die een tabellijst met alle mappen en bestanden bevat. Het biedt de volgende functies:

- **pas** aan: U kunt de kolommen wijzigen die door **worden getoond te gebruiken** optie aanpassen die bij de hoogste juiste hoek van de mening van de Bewaarplaats wordt gevestigd. Met deze optie kunt u elke kolom tonen of verbergen en de kolommen naar wens opnieuw rangschikken. De **kolommen van de Naam** of **Titel** zijn verplicht en allebei kunnen niet samen worden onbruikbaar gemaakt. Andere gebieden, zoals **het type van Dossier**, **UUID**, **de staat van het Document**, **die door** wordt vergrendeld, **op** wordt gecreeerd, en **Gewijzigd op**, kan worden toegelaten of zoals nodig worden onbruikbaar gemaakt. U kunt ze opnieuw rangschikken door ze gewoon te slepen en neer te zetten.

  ![](images/customize-repo-view.png){width="350" align="left"}

- **Kolom resizing**: De kolommen kunnen resized door opties van het kolomdrop-down menu te selecteren.

- **Sorterend**: De Naam, Titel, Gemaakt op en Laatste veranderde kolommen steunen sorterend in het stijgen of dalende orde, toegankelijk via hun kolom dropdown menu.
...
- **menu van Opties voor omslagen**: U kunt de volgende acties uitvoeren gebruikend het **menu van Opties** beschikbaar voor een omslag:
...
- **menu van Opties voor dossiers**: U kunt de volgende acties uitvoeren gebruikend het **menu van Opties** voor een dossier:
  ...
  ![](images/options-file-repo-new.png){width="350" align="left"}
   ...
   - **Slot**: Krijg een slot op het geselecteerde dossier voor het uitgeven.
   - **Voorproef**: Krijg een snelle voorproef van het dossier (.dita, .xml, audio, video, of beeld) zonder het te openen.
   - **Dupliceer**: Gebruik deze optie om een dubbel of een exemplaar van het geselecteerde dossier tot stand te brengen.
   - **Beweging aan**: Gebruik deze optie om het geselecteerde dossier naar een andere omslag te verplaatsen.
   - **anders noemen**: Gebruik deze optie om het geselecteerde dossier anders te noemen.
...
Nadat de onderzoeksresultaten verschijnen, kunt u of multi-uitgezochte dossiers en hen openen in de Redacteur gebruikend **uitgeven** pictogram, of met alle resultaten werken door uw onderzoeksresultaten naar de Redacteur door **te verzenden tonen in het paneel van het Onderzoek** optie.
