...
Op de volgende tabbladen vindt u instructies voor het toevoegen van aangepaste DITA-elementen of -kenmerken in het bestand met zoekserienummering op basis van uw Experience Manager Guides-instellingen: Cloud Service of On-Premise.
...
Op de volgende tabbladen vindt u instructies voor het inschakelen van de optie voor het uitnemen van metagegevens in `configMgr` op basis van uw Experience Manager Guides-instellingen: Cloud Service of On-Premise.
...
Op de volgende tabbladen vindt u instructies waarmee u de tijdelijke vertaalmap kunt uitsluiten van de zoekopdracht op basis van uw Experience Manager Guides-instellingen: Cloud Service of On-Premise.
