...
# Bestaande AEM-sitesjablonen aanpassen
...
>[!NOTE]
>
> Controleer of componenten die sling :resourceType gebruiken onder `wcm/foundation/components` , zijn gemigreerd naar het corresponderende `core/wcm/components` .
