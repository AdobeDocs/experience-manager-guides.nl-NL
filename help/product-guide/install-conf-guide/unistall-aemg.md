...
# AEM Guides for On-Premise verwijderen{#id21BHG0C0SXA}

U kunt AEM Guides for On-Premise verwijderen met CRX Package Manager. Tijdens het verwijderen wordt de inhoud van de opslagplaats teruggezet naar de momentopname die vlak voor de installatie van het pakket is gemaakt.

Voer de volgende stappen uit om AEM Guides for On-Premise te verwijderen:
...
1. Zoek naar `com.adobe.fmdita` -pakket.
