...
>[!NOTE]
>
> In de opstelling op-gebouw, verschijnt de **optie van Montages** in de het tabbar van de Redacteur. In de opstelling van Cloud Service, is deze optie anders genoemd aan **montages van Workspace**. Alle bestaande configuratieopties beschikbaar onder **montages van de Redacteur** blijven onveranderd.
> ![Editor-instelling voor Op locatie ](assets/editor-settings-on-prem.png){width="650" align="left"}
