...
Op de volgende tabbladen vindt u instructies voor het configureren van automatische bestandsnamen op basis van UUID op basis van uw Experience Manager Guides-instellingen: Cloud Service of On-Premise.
...
Gebruik de instructies die in [&#x200B; worden gegeven met voeten treedt van de Configuratie &#x200B;](download-install-config-override.md#) om het configuratiedossier tot stand te brengen. Geef in het configuratiebestand de volgende \(eigenschap\)-details op om automatische bestandsnamen te configureren op basis van UUID:
