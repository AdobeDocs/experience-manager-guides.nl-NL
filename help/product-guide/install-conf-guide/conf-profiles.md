...
- **de Configuraties van de Redacteur van XML**: Gebruik dit lusje om het blik-en-gevoel en diverse eigenschappen van de Redacteur van het Web aan te passen. De volgende configureerbare montages zijn beschikbaar voor de Redacteur van het Web:
   ...
   - Alleen pagina-indeling van XML-editor voor Cloud Service
...
**Aangepast attribuut van het Gebruik**

Als u een aangepast kenmerk gebruikt, moet dit een geldig DITA-kenmerk zijn dat door het DTD-bestand wordt ondersteund. Op de volgende tabbladen vindt u instructies voor het gebruik van elk kenmerk. Dit is geen standaard DITA-kenmerk op basis van de Experience Manager Guides-instelling: Cloud Service of On-Premise.
...
Op de volgende tabbladen vindt u instructies voor het configureren van de ontwerpsjablonen op basis van uw Experience Manager Guides-instellingen: Cloud Service of On-Premise.
...
1. Voer een van de volgende handelingen uit om een uitvoervoorinstelling te maken of te bewerken:
   ...
   - Klik **uitgeven** om de geselecteerde vooraf ingestelde configuratie voor het uitgeven te openen.
     ...
     Voor informatie over output vooraf ingestelde montages afhankelijk van de opstelling u gebruikt, zie *Begrijpend de output vooraf instelt* in Gebruikend Adobe Experience Manager Guides.
...
## AI-assistent configureren voor slimme Help en authoring (alleen voor Cloud Service)
...
U kunt de AI-Gedreven slimme **Hulp** vormen om de Auteurs te helpen vragen stellen en gemakkelijk de vereiste inhoud van de [&#x200B; documentatie van Experience Manager Guides &#x200B;](https://experienceleague.adobe.com/nl/docs/experience-manager-guides/using/overview) vinden.
...
Op de volgende tabbladen vindt u informatie die is gebaseerd op uw Experience Manager Guides-instellingen: Cloud Service of On-Premise.
...
Met deze instelling bepaalt u de werkbalk en de andere gebruikersinterface-elementen van de Editor. Selecteer het **pictogram van de Download** om het `ui\_config.json` dossier op uw lokaal systeem te downloaden. Vervolgens kunt u het bestand wijzigen en het bestand uploaden. Afhankelijk van de plaats waar u het bestand uploadt op, algemeen profiel of mapniveau, worden de wijzigingen dienovereenkomstig toegepast. Voor meer details over hoe te om de Redacteur van XML aan te passen gebruikend `ui\_config.json file`, mening [&#x200B; pas toolbar &#x200B;](customize-toolbar.md#) aan.
