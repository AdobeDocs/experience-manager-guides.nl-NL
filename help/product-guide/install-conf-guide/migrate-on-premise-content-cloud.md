...
* Experience Manager Guides moet de UUID-versie hebben. Als u een niet-UUID versie van Adobe Experience Manager Guides gebruikt, migreer eerst aan UUID gebruikend de stappen in [&#x200B; Migreer niet-DITA inhoud &#x200B;](../install-conf-guide/uuid-non-uuid.md).
