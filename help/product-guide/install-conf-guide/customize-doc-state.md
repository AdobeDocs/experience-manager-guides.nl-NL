...
1. Klik **creëren Profiel** en ga de volgende details in:
   ...
   - Specificeer de staten van het document in de **Toegestane Staten** onder **Staten**.

     De standaarddocumentstatussen zijn Concept, Bewerken, In-Review, Goedgekeurd en Gereed.-
...
Op de volgende tabbladen vindt u instructies voor het automatiseren van de wijziging van de documentstatus op basis van de Experience Manager Guides-instellingen: Cloud Service of On-Premise.
...
AEM Guides biedt een workflow voor documentgoedkeuring waarmee u de levenscyclus van het ontwikkelingsproces van uw document kunt bepalen.

Op de volgende tabbladen vindt u instructies voor het inschakelen van de goedkeuringswerkstroom op basis van de Experience Manager Guides-instellingen: Cloud Service of On-Premise.
