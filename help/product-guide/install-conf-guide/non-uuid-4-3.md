...
> * Als u een versie gebruikt die ouder is dan 4.3.1, voert u een upgrade uit naar versie 4.3.1. Volg de [&#x200B; verbeteringsinstructies &#x200B;](./upgrade-aemg-latest-version.md) specifiek voor de vergunning gegeven versie van uw product.
...
Voor meer details, zuiveren de mening [&#x200B; oudere versies &#x200B;](../install-conf-guide/version-management.md#purge-older-versions-of-dita-files).
...
1. Start `http://<server-name>/libs/fmdita/clientlibs/xmleditor_uuid_upgrade/page.html` .
   ...
   ![&#x200B; de verbeteringslusje van het Systeem in migratie &#x200B;](assets/migration-system-upgrade-4-3-1.png)
   >[!NOTE]
   >
...
| Samenvatting na voltooiing van proces | Hoe interpreteren? | Actie |
|---|---|---|
