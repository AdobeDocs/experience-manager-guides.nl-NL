...
### Zet uw bestaande documenten van Word in DITA onderwerptype document om

Op de volgende tabbladen vindt u instructies voor het converteren van uw bestaande Word-documenten naar DITA-onderwerpdocumenten op basis van uw Experience Manager Guides-instellingen: Cloud Service of On-Premise.
...
1. Upload de Word-brondocumenten naar deze map. Voor informatie bij het uploaden van inhoud op DAM, zie [&#x200B; Bestaande inhoud uploaden DITA &#x200B;](upload-dita-content.md#).
...
In het algemeen, vereist het omzettingsproces u om [&#x200B; InDesign dossiers voor omzetting &#x200B;](aemg-appendix.md#id195DBF0045Z) voor te bereiden en [&#x200B; het kaartdossier voor InDesign aan migratie DITA &#x200B;](aemg-appendix.md#id194AF0003HT) voor te bereiden, dan moet u de bepaalde procedure volgen om het omzettingsproces in werking te stellen.
...
1. Maak een overlayknooppunt van de map `config` in het knooppunt `apps` .
   ...
   - Geef in het element `mapStyle` de locatie op van het toewijzingsbestand dat toewijzingen voor InDesign-documentstijlen aan DITA-elementen bevat. De standaardtoewijzing wordt opgeslagen in het bestand dat zich bevindt op:
     ...
     >[!NOTE]
     >
     > Voor meer informatie over de structuur van `stmap.adobeidml.xml` dossier en hoe u het kunt aanpassen, zie [&#x200B; Bijlage &#x200B;](aemg-appendix.md#id194AF0003HT).
...
1. Upload de InDesign-brondocumenten naar deze map. Voor informatie bij het uploaden van inhoud op DAM, zie [&#x200B; Bestaande inhoud uploaden DITA &#x200B;](upload-dita-content.md#).
...
### Converteer uw bestaande XHTML-document naar DITA-onderwerp

Op de volgende tabbladen vindt u instructies voor het converteren van uw bestaande XHTML-document naar DITA-onderwerp op basis van uw Experience Manager Guides-instellingen: Cloud Service of On-Premise.
...
1. Upload de bron-XHTML-documenten naar deze map. Voor informatie bij het uploaden van inhoud op DAM, zie [&#x200B; Bestaande inhoud uploaden DITA &#x200B;](upload-dita-content.md#).
...
1. Nadat u de vereiste parameters in het `h2d_io.xml` -bestand hebt geconfigureerd, meldt u zich aan bij AEM en opent u de gebruikersinterface van Assets.
...
Na de conversie kan de gestructureerde inhoud naar AEM Guides worden gemigreerd. Voor meer details, de mening [&#x200B; uploadt bestaande inhoud DITA gebruikend het hulpmiddel WebDAV en FrameMaker &#x200B;](./upload-dita-content.md).
...
Op de volgende tabbladen vindt u instructies voor het migreren van andere gestructureerde documenten die zijn gebaseerd op de Experience Manager Guides-instellingen: Cloud Service of On-Premise.
...
1. Upload de gestructureerde brondocumenten naar deze map. Voor informatie bij het uploaden van inhoud op DAM, zie [&#x200B; Bestaande inhoud uploaden DITA &#x200B;](upload-dita-content.md#).
