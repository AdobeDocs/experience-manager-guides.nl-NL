...
# De AI-assistent voor Cloud Service configureren
...
7. [Slimme suggesties configureren in mapprofiel](./conf-profiles.md#configure-ai-assistant-for-smart-help-and-authoring)
...
Voor details, verwijs naar [&#x200B; Vorm Slimme Suggesties in het Profiel van de Omslag &#x200B;](./conf-profiles.md#configure-ai-assistant-for-smart-help-and-authoring).
