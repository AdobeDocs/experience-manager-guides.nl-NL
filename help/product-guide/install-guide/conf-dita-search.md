...
AEM herkent standaard geen DITA-inhoud, waardoor het geen mechanisme biedt om DITA-inhoud in de opslagplaats te doorzoeken. Met AEM hulplijnen kunt u de zoekfunctie voor DITA-inhoud toevoegen aan AEM opslagplaats.
...
1. Selecteer de **DITA-metagegevensextractie inschakelen** -optie.
...
1. Voeg de volgende eigenschap toe aan het knooppunt damAssetLucene:
   ...
   |-------------|----|-----|
   | excludePaths | Tekenreeks\[\] | Voeg de volgende waarde toe aan deze eigenschap: <br>/content/dam/projects/vertaling\_output |
