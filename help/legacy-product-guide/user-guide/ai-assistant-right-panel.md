...
>[!NOTE]
>
> Om de AI Hulpeigenschap in het juiste paneel toe te voegen, moet uw systeembeheerder de **AI Medewerker** optie onder het **3&rbrace; lusje van Comités &lbrace;in het** de montages van Workspace **![&#x200B; de montagespictogram van Workspace &#x200B;](./images/editor_settings_icon.svg) selecteren.**
