...
>[!NOTE]
>
> Om de AI Hulpeigenschap in het juiste paneel toe te voegen, moet uw systeembeheerder de **AI Medewerker** optie onder het **3} lusje van Comités {in het** de montages van Workspace **![ de montagespictogram van Workspace ](./images/editor_settings_icon.svg) selecteren.**
