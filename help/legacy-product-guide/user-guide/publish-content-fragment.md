...
Voeg bijvoorbeeld `/conf/we-retail` toe in de cloudconfiguratie. Deze configuratie verbindt alle modellen van het Fragment van de Inhoud met de omslag.\
   ![&#x200B; voeg de details van de wolkenconfiguratie in de omslageigenschappen toe](images/fragment-folder-cloud-configuration.png){width="650" align="left"}
...
1. In **produceer de dialoogdoos van het Fragment van de Inhoud**, vul de volgende details onder de **Algemene** en **Afbeelding** lusjes in.
   ...
   **Algemene** tabel
   ![&#x200B; voeg het fragmentmodel en toewijzingsdetails in toe publiceren als de dialoog van het Fragment van de Inhoud](images/generate-content-fragment.png)
