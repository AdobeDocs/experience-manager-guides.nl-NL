...
Voor details, verwijs naar [ configuratie HTML5 ](#id231KJA00REJ).

**van het kaartdashboard**

Als u uitvoervoorinstellingen voor PDF wilt openen, klikt u op een DITA-toewijzingsbestand in de Assets-interface, klikt u op Voorinstellingen uitvoer en vervolgens op de optie HTML5. In het dashboard van de Kaart, geeft de klik **** op de bovenkant uit om de diverse configuraties bij te werken, en klikt dan **sparen**.
