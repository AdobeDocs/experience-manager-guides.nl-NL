...
- **voeg Commentaar** \ (![](images/review-comment-icon.svg) \) toe: Als u een kleverig notitietype van commentaar wilt toevoegen, klik het Add pictogram van de Commentaar en ga de commentaar in pop-up in.
